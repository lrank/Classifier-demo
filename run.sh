...
#training data
./featureextractcopy < nctest2007en.parse.out > train_data
./featureextract_negcopy < nctest2007cz.parse.out >> train_data

#testing data
./featureextractcopy < nctest2007en600.parse.out > test.out
#./featureextract < nctest2007en.parse.out > test.out
./featureextract_negcopy < nctest2007cz.parse.out >> test.out
./featureextract_negcopy < nctest2007de.parse.out >> test.out
./featureextract_negcopy < nctest2007es.parse.out >> test.out
./featureextract_negcopy < nctest2007fr.parse.out >> test.out
